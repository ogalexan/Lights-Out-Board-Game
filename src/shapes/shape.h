...
public:
    ...
    /// @param key The integer (1-25) corresponding to box
    /// @param state Corresponding to state of light switch on = 1 or off = 0
    Shape(Shader& shader, vec2 pos, glm::vec2 size, color color, int key, int state);
